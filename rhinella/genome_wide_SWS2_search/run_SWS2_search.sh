...
python2.7 run_blast.SWS2.protein.py RhinellaDB/rhinella.0 7 

# make a fasta that now includes the results of the blast search, using hits with evals < 1e-10
python2.7 make_fasta_from_tblastn7.py 1e-10 output/SWS2_results.7.tblastn.txt ../rhinella_data/GCA_900303285.1_RM170330_genomic.fna >> output/SWS2_in_tree.noHyph.With_tblastn.translated.fasta 
...
python2.7 get_putative_ortholog_names.py output/Gene_annot_results.6.tblastn.txt ../../ranitomeya/genome_wide_SWS2_search/infiles/rna.fa > output/most_similar_gene_in_nanorana.txt
