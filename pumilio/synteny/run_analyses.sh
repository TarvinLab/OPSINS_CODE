...
# Make blast db
# from rescaffolded genome
#python2.7 make_blast_db.py pumilio_data/Oophaga_pumilio_P_RNA-scaffolded_genome.fasta 0
# from Rogers et al. genome
python2.7 make_blast_db.py pumilio_data/Oophaga.clean.newest.fa 0

# running blast to determine the scaffold that contains LWS
python2.7 run_blast.py OophagaDB/Oophaga.0 0 6
...
# from Rogers et al. genome
python2.7 get_LWS_scaffolds.py pumilio_data/Oophaga.clean.newest.fa $myvar > output/LWS_scaffold.fa 
