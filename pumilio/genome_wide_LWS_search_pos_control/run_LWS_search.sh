...
python2.7 run_blast.LWS.protein.py ../synteny/OophagaDB/Oophaga.0 7 

# make a fasta that nw includes the results of the blast search, using hits with evals < 1e-10
python2.7 make_fasta_from_tblastn7.py 1e-10 output/LWS_results.7.tblastn.txt ../synteny/pumilio_data/Oophaga.clean.newest.fa >> output/LWS_in_tree.noHyph.With_tblastn.translated.fasta 
